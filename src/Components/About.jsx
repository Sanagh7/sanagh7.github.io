...
const About = () => {
  const aboutImageSrc = typeof aboutImg === "string" ? aboutImg : aboutImg.src;

  return (
    <div className="relative border-b border-neutral-800 pb-24 pt-20 overflow-hidden bg-[#060921]">
      {/* Enhanced background elements */}
      <div className="absolute -right-32 top-1/3 -z-10 h-[500px] w-[500px] rounded-full bg-gradient-to-br from-cyan-500/5 to-cyan-500/5 blur-3xl"></div>
      <div className="absolute -left-32 bottom-0 -z-10 h-[400px] w-[400px] rounded-full bg-gradient-to-br from-purple-500/5 to-cyan-500/5 blur-3xl"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 mb-16">
          ...
          >
            <div className="relative aspect-square overflow-hidden rounded-2xl shadow-xl">
              ...
              <motion.div 
                className="absolute top-24 left-6 bg-gradient-to-r from-purple-500 to-cyan-500 rounded-full px-4 py-2 text-white font-medium text-sm shadow-lg"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              <motion.div 
                className="absolute bottom-24 right-8 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-full px-4 py-2 text-white font-medium text-sm shadow-lg"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
            ...
            {/* Background glow */}
            <div className="absolute -bottom-6 -right-6 -z-10 h-48 w-48 rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 opacity-20 blur-2xl"></div>
            <div className="absolute -top-6 -left-6 -z-10 h-40 w-40 rounded-full bg-gradient-to-r from-purple-500 to-cyan-500 opacity-20 blur-2xl"></div>
          </motion.div>
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              >
                ...
                >
                  ...
                  <span className="relative flex h-full w-full items-center justify-center rounded-full bg-[#080325] px-6 py-3 text-sm sm:text-base transition-all duration-300 ease-out group-hover:bg-opacity-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="flex items-center gap-4 bg-gradient-to-br from-neutral-900/50 to-neutral-900/50 border border-neutral-800 rounded-xl p-5 group hover:border-cyan-500/50 transition-all duration-300"
              >
